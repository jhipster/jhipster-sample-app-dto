...
describe('Label e2e test', () => {
  ...
  let username: string;
  let password: string;
  const labelSample = { label: 'potentially aching comestible' };
  ...
  describe('Label page', () => {
    it('should have translated page title', () => {
      ...
      cy.getEntityHeading('Label').should('not.contain', 'jhipsterDtoSampleApplicationApp.label.home.title');
    });
  ...
  describe('new Label page', () => {
    ...
    it('should create an instance of Label', () => {
      cy.get(`[data-cy="label"]`).type('cake yippee plastic');
      cy.get(`[data-cy="label"]`).should('have.value', 'cake yippee plastic');
