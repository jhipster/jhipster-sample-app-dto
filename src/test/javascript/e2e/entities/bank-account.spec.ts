...
describe('BankAccount e2e test', () => {
    ...
    it('should load BankAccounts', () => {
        ...
        expect(bankAccountComponentsPage.getTitle()).toMatch(/jhipsterDtoSampleApplicationApp.bankAccount.home.title/);
    ...
    it('should load create BankAccount dialog', () => {
        ...
        expect(bankAccountDialogPage.getModalTitle()).toMatch(/jhipsterDtoSampleApplicationApp.bankAccount.home.createOrEditLabel/);
