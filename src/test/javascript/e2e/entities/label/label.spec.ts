...
describe('Label e2e test', () => {
    ...
    it('should load Labels', async () => {
        ...
        expect(await labelComponentsPage.getTitle()).to.eq('jhipsterDtoSampleApplicationApp.label.home.title');
    });

    it('should load create Label page', async () => {
        await labelComponentsPage.clickOnCreateButton();
        labelUpdatePage = new LabelUpdatePage();
        expect(await labelUpdatePage.getPageTitle()).to.eq('jhipsterDtoSampleApplicationApp.label.home.createOrEditLabel');
    ...
    it('should delete last Label', async () => {
        ...
        expect(await labelDeleteDialog.getDialogTitle()).to.eq('jhipsterDtoSampleApplicationApp.label.delete.question');
