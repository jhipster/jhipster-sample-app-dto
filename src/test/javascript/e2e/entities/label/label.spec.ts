...
describe('Label e2e test', () => {
    ...
    it('should load Labels', async () => {
        ...
        expect(await labelComponentsPage.getTitle()).toMatch(/jhipsterDtoSampleApplicationApp.label.home.title/);
    });

    it('should load create Label page', async () => {
        await labelComponentsPage.clickOnCreateButton();
        labelUpdatePage = new LabelUpdatePage();
        expect(await labelUpdatePage.getPageTitle()).toMatch(/jhipsterDtoSampleApplicationApp.label.home.createOrEditLabel/);
    ...
    it('should delete last Label', async () => {
        ...
        expect(await labelDeleteDialog.getDialogTitle()).toMatch(/jhipsterDtoSampleApplicationApp.label.delete.question/);
