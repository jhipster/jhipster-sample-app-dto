...
describe('Operation e2e test', () => {
    ...
    it('should load Operations', async () => {
        ...
        expect(await operationComponentsPage.getTitle()).toMatch(/jhipsterDtoSampleApplicationApp.operation.home.title/);
    });
    ...
    it('should load create Operation page', async () => {
        ...
        expect(await operationUpdatePage.getPageTitle()).toMatch(/jhipsterDtoSampleApplicationApp.operation.home.createOrEditLabel/);
    ...
    it('should delete last Operation', async () => {
        ...
        expect(await operationDeleteDialog.getDialogTitle()).toMatch(/jhipsterDtoSampleApplicationApp.operation.delete.question/);
