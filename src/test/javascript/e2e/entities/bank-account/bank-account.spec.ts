...
describe('BankAccount e2e test', () => {
  ...
  it('should load BankAccounts', async () => {
    ...
    expect(await bankAccountComponentsPage.getTitle()).to.eq('jhipsterDtoSampleApplicationApp.bankAccount.home.title');
    await browser.wait(
  ...
  it('should load create BankAccount page', async () => {
    ...
    expect(await bankAccountUpdatePage.getPageTitle()).to.eq('jhipsterDtoSampleApplicationApp.bankAccount.home.createOrEditLabel');
  ...
  it('should delete last BankAccount', async () => {
    ...
    expect(await bankAccountDeleteDialog.getDialogTitle()).to.eq('jhipsterDtoSampleApplicationApp.bankAccount.delete.question');
