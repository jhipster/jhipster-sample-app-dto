...
describe('BankAccount e2e test', () => {
    ...
    it('should load BankAccounts', async () => {
        ...
        expect(await bankAccountComponentsPage.getTitle()).toMatch(/jhipsterDtoSampleApplicationApp.bankAccount.home.title/);
    });
    ...
    it('should load create BankAccount page', async () => {
        ...
        expect(await bankAccountUpdatePage.getPageTitle()).toMatch(/jhipsterDtoSampleApplicationApp.bankAccount.home.createOrEditLabel/);
    ...
    it('should delete last BankAccount', async () => {
        ...
        expect(await bankAccountDeleteDialog.getDialogTitle()).toMatch(/jhipsterDtoSampleApplicationApp.bankAccount.delete.question/);
