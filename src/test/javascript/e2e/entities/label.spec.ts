...
describe('Label e2e test', () => {
    ...
    it('should load Labels', () => {
        ...
        expect(labelComponentsPage.getTitle()).toMatch(/jhipsterDtoSampleApplicationApp.label.home.title/);
    ...
    it('should load create Label dialog', () => {
        ...
        expect(labelDialogPage.getModalTitle()).toMatch(/jhipsterDtoSampleApplicationApp.label.home.createOrEditLabel/);
