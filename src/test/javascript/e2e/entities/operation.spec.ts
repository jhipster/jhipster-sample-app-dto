...
describe('Operation e2e test', () => {
    ...
    it('should load Operations', () => {
        ...
        expect(operationComponentsPage.getTitle()).toMatch(/jhipsterDtoSampleApplicationApp.operation.home.title/);
    ...
    it('should load create Operation dialog', () => {
        ...
        expect(operationDialogPage.getModalTitle()).toMatch(/jhipsterDtoSampleApplicationApp.operation.home.createOrEditLabel/);
