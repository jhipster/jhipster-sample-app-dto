(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope, $translate) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('jhipsterDtoSampleApplicationApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-jhipsterDtoSampleApplicationApp-error');
                var entityKey = httpResponse.headers('X-jhipsterDtoSampleApplicationApp-params');
                if (errorHeader) {
                    ...
                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                        ...
                        var fieldName = $translate.instant('jhipsterDtoSampleApplicationApp.' + fieldError.objectName + '.' + convertedField);
