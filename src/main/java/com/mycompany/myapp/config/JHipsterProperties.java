...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "sampleDTO@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "sampleDTO API";

        private String description = "sampleDTO API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "sampleDTO";
